...
<div class="alert-BYS">
   ...
   <div class="alert-links"> 
      <a target="_self" href="https://developers.yoti.com/yoti-doc-scan/integration-guide">See Integration guide</a> 
   </div>
</div>
{% /html %}
...
<div class="alert-GTK">
    ...
    <div class="alert-links"> 
        <a href="https://developers.yoti.com/yoti-doc-scan/render-the-user-view">Launch the user view</a>
   </div>
</div>
{% /html %}
