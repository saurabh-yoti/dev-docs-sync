...
You will also need some sandbox api keys.
   ...
   <div class="alert-links"> 
      ...
      <a target="_self" href="https://developers.yoti.com/yoti-doc-scan/integration-guide">Integration Guide</a> 
...
1. [Generating sandbox keys](https://developers.yoti.com/yoti/generate-sandbox-api-keys)
2. [Installing the sandbox SDK](https://developers.yoti.com/yoti-doc-scan/sandbox-docscan#install-the-sandbox-sdk)
3. [Generating a sandbox session](https://developers.yoti.com/yoti-doc-scan/sandbox-docscan#generating-a-sandbox-session)
4. [Configuring the response ](https://developers.yoti.com/yoti-doc-scan/sandbox-docscan#configure-the-responses)([breakdown ](https://developers.yoti.com/yoti-doc-scan/sandbox-docscan#sandbox-breakdown)version available too)
5. [Launching the user view](https://developers.yoti.com/yoti-doc-scan/sandbox-docscan#launching-the-user-view)
...
For further details, please see [](/yoti-doc-scan/understanding-the-report).