...
There is one step to follow to integrate the Yoti Age Scan:

[1) Create an age estimation request](https://developers.yoti.com/yoti-age-scan/integration-guide#create-a-request)
...
<div class="alert-GTK">
    ...
    <div class="alert-links"> 
        <a href="https://developers.yoti.com/yoti-age-scan/user-experience">User experience</a>
   </div>
{% /html %}
