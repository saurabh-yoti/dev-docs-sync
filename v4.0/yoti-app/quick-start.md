...
## [🏖](https://developers.yoti.com/yoti-doc-scan/quick-start#sandbox-examples) Sandbox web examples
...
Below is an example complete request snippet in different languages. The documentation continues to outline the full request in [step by step detail](https://developers.yoti.com/yoti-app/integration-guide). Please have a read. 
...
In this example we use the modal button but please feel free to look at our [other button examples](https://developers.yoti.com/yoti-app/integration-guide#generate-a-yoti-button). 
