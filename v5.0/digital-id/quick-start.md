...
In this example we use the modal button but please feel free to look at our other [button](/digital-id/createbutton) examples.
...
| [Go](https://github.com/getyoti/yoti-dotnet-sdk#running-the-profile-examples) | [Go](https://github.com/getyoti/yoti-go-sdk/tree/master/_examples/profilesandbox) | 
