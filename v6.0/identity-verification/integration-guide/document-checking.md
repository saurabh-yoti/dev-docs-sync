...
Please not manual text extraction is not possible with these documents. There is an option to enable all non-latin characters documents or you can limit to what you want to support using the filters described above. Data provided back will be best case scenario in terms of translations.
