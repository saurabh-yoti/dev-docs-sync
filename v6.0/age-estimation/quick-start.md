...
Please ensure you have a verified organisation and generate Age keys. 

---

## Age estimation and anti-spoofing API
...
## Age estimation API only

We recommend you read through all the documentation.
