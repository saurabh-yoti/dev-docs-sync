...
{% badge type="warning" text="Help" /%} If integrating into a non-browser client, we recommend you contact us through our [support form](https://support.yoti.com/yotisupport/s/contactsupport)  for additional support.
