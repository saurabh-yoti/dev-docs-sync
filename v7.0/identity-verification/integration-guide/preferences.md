...
var sdkConfig = new SdkConfigBuilder()
                ...
                .WithSuccessUrl("/your/success/url")
                .WithErrorUrl("/your/error/url")
                .WithPrivacyPolicy("/your/privacy-policy/url")
...
| withPrivacyPolicyUrl | [https://yourdomain.com/privacy-policy](https://yourdomain.com/error) | Allows the relying business to add their privacy policy url into the biometric consent step. Links to the business provided privacy policy url if the biometric consent screen is enabled. | ✅ | 
