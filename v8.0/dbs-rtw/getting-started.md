...
Yoti provides a simple dashboard management  tool called [Yoti Hub ](https://hub.yoti.com/login)to get you up and running with our products. The Yoti Hub allows you to generate your API keys, add your billing information and more. 
...
This section walks you through how to complete this process. You will need to know information about your organisation, key contact details and billing details. 
...
{% badge type="info" text="Hint" /%} Yoti Hub is only supported on the web.
...
Get access to the [Yoti Hub ](https://hub.yoti.com/login)by scanning a Yoti QR code with your Digital ID app.
...
<div class="alert-GTK">
    ...
    <div class="alert-text">
        ...
        Once you have logged in, your phone will display a 'connected' screen. If you leave the Yoti app, you won't be able to see receipts in the Yoti Hub. This is for security purposes. Log in to your Yoti app to gain access to receipts.
...
Now, you just have to create your application to generate API keys and you are integration ready. If you are using our portals, you will still need to create applications.
