...
Yoti provides you with a simple dashboard management tool called [Yoti Hub](https://hub.yoti.com) to get you up and running with our products. The Yoti hub allows you to generate your API keys, add your billing information and more.
...
You can go ahead and start using our [sandbox](https://app.developerhub.io/yoti/sandbox-keys) services.
